...
import{S as e}from"./vista-tridimensionale-Dah9k13d.js";import{s as B,m as w,d as Y,a as $,l as z}from"./logDepthDeclaration-DtcWGKya.js";import{h as j}from"./helperFunctions-t-tuX497.js";import{b as k,a as Q,i as Z,c as K,f as q,d as J,e as ee,g as ie,h as ne,j as te,v as re}from"./vertexColorMixing-C65CTFkU.js";import"./index-CA1NhdvG.js";import"./raffica-disegnata-R2Hgas5o.js";const n="decalVertexDeclaration",h=`#ifdef DECAL
...
`;e.ShadersStore[N]||(e.ShadersStore[N]=b);const pe=[ae,de,B,w,Y,oe,j,k,Q,Z,fe,$,se,le,K,q,ce,Ee,Ie,me,z,ve,ue,J,ee,ie,Ae,Te,_e,Se,ne,te,Ne,re,he,Me];for(const i of pe)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Ue={name:N,shader:b};export{Ue as defaultVertexShader};
