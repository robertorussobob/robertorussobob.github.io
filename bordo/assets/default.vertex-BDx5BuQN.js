...
import{S as e}from"./vista-tridimensionale-BVJ1Shrj.js";import{s as z,m as C,d as H,a as w,l as B}from"./logDepthDeclaration-Ce_oQZBn.js";import{h as Y}from"./helperFunctions-CnjVEEAA.js";import{b as $,a as j,i as k,c as Q,f as K,d as Z,e as q,g as J,h as ee,j as te,v as ie}from"./vertexColorMixing-Dy8x4Br_.js";import"./index-BNldl97H.js";import"./raffica-disegnata-R2Hgas5o.js";const i="uvAttributeDeclaration",S=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=P);const me={name:c,shader:P},m="uvVariableDeclaration",X=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=X);const _e={name:m,shader:X},_="samplerVertexImplementation",D=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=D);const xe={name:_,shader:D},x="bumpVertex",G=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
`;e.ShadersStoreWGSL[T]||(e.ShadersStoreWGSL[T]=F);const Se=[z,C,H,re,Y,$,j,k,ne,w,ae,fe,Q,K,de,oe,se,ue,B,ve,le,pe,ce,Z,q,J,me,_e,xe,Ee,ee,te,Ie,ie,Te];for(const t of Se)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const ge={name:T,shader:F};export{ge as defaultVertexShaderWGSL};
